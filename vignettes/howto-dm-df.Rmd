...
In this tutorial we have demonstrated how to use {dm} with local data frames to take advantage of the power of relational data models without losing access to the familiar R way of working with data frames.
If you want to learn more about relational data models, there is a good introduction in `vignette("howto-dm-theory")`. You may then wish to read about using dm to work with databases in more detail in `vignette("howto-dm-db")`.
